  ...
  return (
    <div className="bg-white py-10 px-10">
      ...
      <div className="bg-white py-12">
        <div className="container mx-auto px-6 flex items-center md:flex-row md:justify-between flex-col-reverse">
          <p className="text-black text-center mb-4 ">©2024 by Meliana All Rights Reserved.</p>
